...
const MARKETS: MarketInstrument[] = [
  ...
  },
  {
    id: "ger30",
    tvSymbol: "FXCM:GER30",
    chartTitle: "DAX Index",
    name: "DAX Index",
    ticker: "GER30",
    change: "-0.43%",
    changeUp: false,
    flicker: { initial: 23269.26, vol: 0.001 },
    mini: { base: 23270, n: 20, vol: 0.008, up: false },
    icon: "🇩🇪",
  },
  {
    id: "fra40",
    tvSymbol: "FOREXCOM:FRA40",
    chartTitle: "CAC 40 Index",
    name: "CAC 40 Index",
    ticker: "FRA40",
    change: "+0.10%",
    changeUp: true,
    flicker: { initial: 7991.5, vol: 0.001 },
    mini: { base: 7990, n: 20, vol: 0.008, up: true },
    icon: "🇫🇷",
  },
  {
    id: "us30",
...
export function MarketView() {
  ...
  const filteredMarkets = (() => {
    ...
    if (tabId === "forex") {
      return MARKETS.filter((m) => m.id === "eurusd");
    }
    if (tabId === "commodities") {
      return MARKETS.filter((m) =>
        ["gold", "silver", "oil", "brent"].includes(m.id)
      );
    }
    if (tabId === "indexes") {
